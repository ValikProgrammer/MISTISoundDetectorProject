...
ros2 run movement movement.py --ros-args -p left_vel_mult:=0.75 -p right_vel_mult:=0.5 -p volume_threshold:=5.0 -p scan_360_duration:=7.0 -p scan_90_duration:=2.0 -p scan_speed:=0.5 -p rotate_speed:=0.5 -p forward_speed:=1.0 -p sound_decrease_threshold:=12.0 -p target_range:=0.3
